...
public class AddMechanicAction implements Action {
    ...
    private final String INFO_MESSAGE = "Specify mechanic description ";


    @Override
    public void execute() {
        try {
            CarService.getInstance().getManageMaster().addMechanic(InputReader.getInstance().listenInput(INFO_MESSAGE));
